...
public class CapitalRingOptions1 extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_capital_ring_options1);
		...
		String[] sections = res.getStringArray(R.array.capital_ring_sections);
		for(int i = 0; i < sections.length; i++) {
			hshSectionMap.put((String)sections[i], i);
		}
		glob.setSectionMap(hshSectionMap);

		source = populateSpinner(R.id.spinner1, R.array.capital_ring_sections);
		destination = populateSpinner(R.id.spinner2, R.array.capital_ring_sections);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.capital_ring_options1, menu);
		return true;
	}
	...
	public void onItemSelected(AdapterView arg0, View arg1, int pos, long arg3) {
		...
		destContents = new ArrayList<String>(Arrays.asList(res.getStringArray(R.array.capital_ring_sections)));
