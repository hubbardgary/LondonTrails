...
public class ShowMapPresenter {
    ...
    public void menuItemSelected(int itemId) {
        ...
        if (itemId == R.id.view_option_streetmap) {
            updateMapType(GoogleMap.MAP_TYPE_NORMAL);
            return;
        } else if (itemId == R.id.view_option_satellite) {
            updateMapType(GoogleMap.MAP_TYPE_HYBRID);
            return;
        } else if (itemId == R.id.view_option_terrain) {
            updateMapType(GoogleMap.MAP_TYPE_TERRAIN);
            return;
        } else if (itemId == R.id.view_option_hide_markers) {
            setMarkerVisibility(false);
            return;
        } else if (itemId == R.id.view_option_show_markers) {
            setMarkerVisibility(true);
            return;
        } else if (itemId == R.id.view_option_reset_focus) {
